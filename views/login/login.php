        ...
        <div class="row w-100">
            <div class="col-lg-4 mx-auto">
                <div class="auto-form-wrapper">
                    <form action="#" ng-submit="connexionUser()">
                        <div class="form-group">
                            <label class="label">E-mail / Nom utilisateur / N° Téléphne</label>
                            <div class="input-group">
                                <input type="text" ng-model="loginUser" class="form-control" placeholder="Tel/Email/pseudo" required>
                ...
                <p class="footer-text text-center">copyright © 2018 SYABE. Tous droits reservés.</p>
            </div>
        </div>
    </div>
